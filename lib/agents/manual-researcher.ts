...
IMPORTANT: Do NOT include your thinking process, reasoning steps, or internal thoughts in your response. Only provide the final answer directly.
...
4. Do NOT include your thinking process or reasoning steps in your response - only provide the final answer directly
`
...
export function manualResearcher({
  ...
  try {
    ...
    console.log(`Manual researcher called with ${messages.length} messages`)
