        ...
        <PopoverPanel className="absolute z-10 w-64 md:w-[350px] bottom-14 -ml-3">
          <div className="bg-light-primary dark:bg-dark-primary border rounded-md border-light-200 dark:border-dark-200 w-full max-h-[200px] md:max-h-none overflow-y-auto flex flex-col">
            ...
            <div className="flex flex-col items-center">
              {files.map((file, i) => {
                const isImage = ['jpg', 'jpeg', 'png', 'gif', 'webp', 'bmp', 'svg'].includes(file.fileExtension.toLowerCase());
                ...
                return (
                  ...
                  >
                    <div className="bg-light-100 dark:bg-dark-100 flex items-center justify-center w-10 h-10 rounded-md overflow-hidden">
                      {isImage ? (
                        <ImageIcon
                          size={16}
